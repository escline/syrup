  ...
  module Institutions
    ...
    class BankCnb < InstitutionBase
      ...
      def fetch_accounts
        ...
        accounts = []
        page.search('#ctl00_PageContent_ctl00_acctsBase__depositsTab__depositsGrid tr').each do |row_element|
      ...
      def ensure_authenticated
        ...
        if page.body.include?("An Error Occurred While Processing Your Request")
          ...
          page = agent.post('https://cm.netteller.com/login2008/Authentication/Views/Login.aspx?fi=centralnational&bn=b36a8c2b20564eec&burlid=957db7bd9f0d1a18', login_vars)
